...
class News1(commands.Cog):
    ...
    async def news(
        ...
        embed.add_field(
            name="Links:",
            value="[Invite](https://discord.com/oauth2/authorize?"
                  "client_id=1248265007381348403&permissions=8&integration_type=0&scope=bot) | "
                  "[Support Server](https://discord.gg/3rbVWaRTpD)"
        )
